package com.myss.regulus.Padapter
...
import com.myss.regulus.Formulario
...
class ProfesorAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.button.setOnClickListener {
            ...
            intent.putExtra("ancestry", estudiante.ancestry)//variable que no esta definida al inicio
            intent.putExtra("yearOfBirth", estudiante.yearOfBirth)
